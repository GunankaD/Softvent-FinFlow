...
public class InvoiceResource {
    ...
    // CREATE
    @POST
    public Response create(@Valid InvoiceCreateRequest request) {
    ...
    @GET
    @Path("/{invoiceNumber}")
    public Response getByInvoiceNumber(@PathParam("invoiceNumber") String invoiceNumber) {
    ...
    @DELETE
    @Path("/{invoiceNumber}")
    public Response voidInvoice(@PathParam("invoiceNumber") String invoiceNumber) {
